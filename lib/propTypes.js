...
export const trailShape = PropTypes.shape({
  ...
  custom_data: PropTypes.shape({
    ...
    recommendedUse: PropTypes.arrayOf(valueLabelShape),
    accessibility: PropTypes.arrayOf(valueLabelShape),
    similarTrails: PropTypes.string,
    trailsNearby: PropTypes.string,
    media: {
      videos: PropTypes.arrayOf(pictureShape),
      pictures: PropTypes.arrayOf(pictureShape)
    },
    jsonCoordinates: PropTypes.shape({
      ID: PropTypes.number,
      id: PropTypes.number,
      title: PropTypes.string,
      filename: PropTypes.string,
