...
export const DownloadGPS = props => {
  const matchTrail = props.trails.find(trail => trail.slug === props.trail.slug)
  let gpxString = ''
      ...
      onClick={
        () => {
          ...
          download(`${props.trail.slug}.gpx`, `
            ...
            <trk>
              <name>${props.trail.title.rendered}</name>
              <trkseg>
                ${gpxString}
              </trkseg>
            </trk>
